// vararr2d.c -- функций, использующие массивы переменной длины
#include <stdio.h>
#define ROWS 3
#define COLS 4
...
int main(void)
{
	...
	for(i = 0; i < rs; i++)
		for(j = 0; j < cs; j++)
			varr[i][j] = i * j + j;
		printf("3x5 array\r\n"); // Традиционный массив
		printf("Sum of all elemets = %d\r\n", sum2d(ROWS, COLS, junk)); // Сумма всех элементов
		printf("2x6 array\r\n"); // Традиционный массив
		printf("Sum of all elemets = %d\r\n", sum2d(ROWS - 1, COLS + 2, morejunk)); // Сумма всех элементов
		printf("3x10 VLA\r\n"); // Массив переменной длины
		printf("Sum of all elemets = %d\r\n", sum2d(rs, cs, varr)); // Сумма всех элементов
		return 0;
}
